...
class Paradox:
    ...
    def __add__(self, other):
        # Saat A + B terjadi, Natumpy tidak menjumlahkan.
        # Ia memprovokasi kedua variabel untuk berkonflik.
        new_ptr = natcore.provoke(self._ptr, other._ptr)
        return Paradox(_ptr=new_ptr)

    def possibilities(self):
        # Melihat semua realitas yang ada tanpa memilih
        return natcore.witness(self._ptr)

    def collapse(self, mode="random"):
        # Memaksa satu realitas terjadi
